 ...
 */
export const GovernedReform: Organization = {
  metadata: {
    id: "governed-reform",
    title: "Governed Reform",
    uri: "https://aqua-famous-sailfish-288.mypinata.cloud/ipfs/bafkreienzmuhomrq2jh3r4sotzckhngxab4of77z75joafeghkh4i3cx7a",
    banner: "https://aqua-famous-sailfish-288.mypinata.cloud/ipfs/bafybeiaxdinbxkpv5xa5od5yjho3bshpvzaacuxcnfgi6ie3galmwkggvi",
    description: "Governed Reform is a demo of how mandates can be adopted and revoked. It has a single mandate that takes an address of a packaged mandate and adopts this package. When executed, the package adopts an entire governance flow. This style of governance reform is uniique to Powers, and one of its greatest strengths.",
    disabled: false,
    onlyLocalhost: true
  },
  fields: [ ],
