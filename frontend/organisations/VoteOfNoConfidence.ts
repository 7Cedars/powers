 ...
 */
export const VoteOfNoConfidence: Organization = {
  metadata: {
    id: "vote-no-confidence",
    title: "Vote of No Confidence",
    uri: "https://aqua-famous-sailfish-288.mypinata.cloud/ipfs/bafkreihujhmq7hfjhm33v44cvgl6xjrik7lx5hkr3bq4jjjuwgs74vedx4",
    banner: "https://aqua-famous-sailfish-288.mypinata.cloud/ipfs/bafybeie47slqacwgjoxx6kqexiau2mzusmcefrckz7uvll6pyizjbaubyy",
    description: "Vote of No Confidence demonstrates how to implement a no confidence logic using Powers. In this case community members can trigger a vote of no confidence against delegates, and if the vote passes, the delegates are removed from their role and a new list election is called.",
    disabled: false,
    onlyLocalhost: true
  },
  fields: [ ],
