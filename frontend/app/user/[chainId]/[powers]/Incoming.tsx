...
// // NB! did some very quick refactoring here. Pretty sure we can do this much more efficiently.
...
//   const allActions: (Action | undefined)[] = powers.laws?.flatMap(law => law.actions) || []
  
//   if (!powers.laws || !allActions) {
//     console.log("@getEnabledActions: Missing laws or allActions", {laws: powers.laws, allActions: allActions})
...
//               const fulfilledActionData = await fetchActionData(BigInt(fulfilledActionId), powers)
...
//                   fulfilledActionData.callData as `0x${string}`, // Use the same callData
//                   BigInt(fulfilledActionData.nonce as string) // Use the same nonce
//                 )
...
//                     upToDate: true,
//                     state: undefined,
//                     fulfilledAt: fulfilledActionData.fulfilledAt
//                   }
...
//   // Wrapper for fetchChainStatus to match the expected signature
