...
- **`Conditions`**: Defines execution conditions like `allowedRole`, `votingPeriod`, `quorum`, parent mandate requirements (`needFulfilled`, `needNotFulfilled`), and time constraints (`delayExecution`, `throttleExecution`).
