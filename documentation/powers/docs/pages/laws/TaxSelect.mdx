...
TaxSelect is an electoral mandate that enables direct assignment or revocation of a specific role to any account. It provides a mechanism for authorized accounts to manage role assignments without requiring nominations.
...
When adopting a TaxSelect instance, two parameters must be provided:
