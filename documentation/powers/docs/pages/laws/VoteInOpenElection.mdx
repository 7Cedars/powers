...
VoteInOpenElection is an electoral mandate that manages the tallying of votes in an election. It provides a mechanism to count votes, determine winners, and assign roles based on election results.
...
When adopting a VoteInOpenElection instance, four parameters must be provided:
