# Cultural Stewardship DAO Specification {#cultural-stewardship-dao-specification}
...
[**Cultural Stewardship DAO Specification	1**](#cultural-stewardship-dao-specification)

[Table of Contents	1](#table-of-contents)

[Organisational Structure & Context	2](#organisational-structure-&-context)

[Vision & Mission	2](#vision-&-mission)

[Architecture: Parent & Sub-DAOs	2](#architecture:-parent-&-sub-daos)

[Treasury Management	2](#treasury-management)

[Parent DAO	3](#parent-dao)

[Roles	3](#roles)

[Executive Mandates	3](#executive-mandates)

[Electoral Mandates	6](#electoral-mandates)

[Reform Mandates	7](#reform-mandates)

[Digital DAO	8](#digital-dao)

[Roles	8](#roles-1)

[Executive Mandates	8](#executive-mandates-1)

[Electoral Mandates	10](#electoral-mandates-1)

[Reform Mandates	11](#reform-mandates-1)

[Ideas DAO	11](#ideas-dao)

[Roles	11](#roles-2)

[Executive Mandates	12](#executive-mandates-2)

[Electoral Mandates	13](#electoral-mandates-2)

[Physical DAO	14](#physical-dao)

[Roles	14](#roles-3)

[Executive Mandates	15](#executive-mandates-3)

[Electoral Mandates	16](#heading=h.cyrcay1wk62d)

[Reform Mandates	17](#reform-mandates-2)

[Off-chain Operations	18](#off-chain-operations)

[Dispute Resolution	18](#dispute-resolution)

[Code of Conduct	18](#code-of-conduct)

[Communication Channels	18](#communication-channels)

[Description of Governance	18](#description-of-governance)

[Risk Assessment	19](#risk-assessment)

[Role Collision	19](#role-collision)

[Dependency Chains	19](#dependency-chains)

## Organisational Structure & Context {#organisational-structure-&-context}
...
### *Architecture: Parent & Sub-DAOs* {#architecture:-parent-&-sub-daos}
...
\-- Here should be a mermaid diagram \-- 

## Parent DAO  {#parent-dao}
...
### *Executive Mandates* {#executive-mandates}
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| Members | Initiate Ideas DAO creation | StatementOfIntent.sol | "string title, string uri" | none | Initiates creation proposal. Vote, normal threshold.  |
...
| Executives | Revoke Ideas DAO | PresetMutlipleActions.sol | (same as above) | Revokes roleId \+ allowance of DAO.  | DAO creation should have executed, members should not have vetoed.  |
...
| Role | Name & Description | Base contract | User Input | Executable Output | Conditions |
| :---- | :---- | :---- | :---- | :---- | :---- |
| Ideas DAO | Initiate Physical DAO Creation | StatementOfIntent.sol | “string title, string uri, uint256 allowance, " | none | Vote, low threshold, long duration. It means that *multiple* ideas DAOs need to ok its creation.  |
| Members | Veto Physical DAO creation  | StatementOfIntent.sol | (same as above) | none | Vote, high threshold & quorum. |
| Executives | Execute Physical DAO Creation | OpenAction.sol | (same as above) | Creates Physical DAO \+ Assigns Role \+ assign Allowance \+ creates claim member role mandate | Proposal exists, veto does not exist  |
| Executives | Assign role Id to Physical DAO | BespokeActionReturnValue.sol | (same as above) | Assigns role to return value of previous mandate.  | Any executive can execute. Previous action executed.  |
| Executives | Assign allowance to Physical DAO | BespokeActionOnReturnValue.sol | (same as above) | Assigns allowance to return value of previous mandate.  | Any executive can execute. Previous action executed. |
| Members | Veto revoking Physical DAO | StatementOfIntent.sol | (same as above) | none | Vote, high threshold.   |
| Executives | Revoke Physical DAO | PresetMutlipleActions.sol | (same as above) | Revokes roleId \+ allowance of DAO.  | DAO creation should have executed, members should not have vetoed.  |

#### Assign additional allowances to Physical DAO or Digital DAO  

| Role | Name & Description | Base contract | User Input | Executable Output | Conditions |
| :---- | :---- | :---- | :---- | :---- | :---- |
| Physical DAO | Veto additional allowance | StatementOfIntent.sol | "address physical or digital DAO", "uint256 amount" | none | Vote, high threshold.  |
| Physical DAO | Request additional allowance | StatementOfIntent.sol | "address physical DAO", "uint256 amount" | none | Initiates allowance proposal.  Note: NOT a vote: any physical DAO can submit. |
| Executives | Grant Allowance to Physical DAO | BespokeAction.sol | (same as above) | Safe.approve(subDao, amount) | Proposal exists, vote, no Physical DAO veto.  |
| Digital DAO | Request additional allowance | StatementOfIntent.sol | "address digital DAO", "uint256 amount" | none | Initiates allowance proposal.  |
| Executives | Grant Allowance to Digital DAO | BespokeAction.sol | (same as above) | Safe.approve(subDao, amount) | Proposal exists, vote, no Physical DAO veto. |
...
| Executives | Tally election | OpenElectionEnd.sol | None | Counts vote, revokes and assigns role accordingly | OpenElectionStart needs to have been executed. Any executive can call this.  |

### *Reform Mandates* {#reform-mandates}
...
### *Executive Mandates* {#executive-mandates-1}
...
| Conveners | Execute payment | SafeAllowanceTransfer.sol | (Same as above) | Call to safe allowance module: transfer | Vote, project should have been submitted.  |
...
### *Electoral Mandates*  {#electoral-mandates-1}
...
| Member | Vote in Election | OpenElectionVote.sol | (bool\[\]. vote\] | Logs a vote | None, any member can vote. This mandate ONLY appear by calling call election.  |
| Conveners | Tally election | OpenElectionEnd.sol | None | Counts vote, revokes and assigns role accordingly | OpenElectionStart needs to have been executed. Any convener can call this.  |

### *Reform Mandates* {#reform-mandates-1}
...
### *Executive Mandates* {#executive-mandates-2}
...
### *Electoral Mandates*  {#electoral-mandates-2}
...
### *Executive Mandates* {#executive-mandates-3}
...
### *Reform Mandates* {#reform-mandates-2}
...
## Description of Governance {#description-of-governance}
