...
StatementOfIntent is an executive mandate that enables the creation of proposals without execution. It provides a mechanism to propose actions that can be executed by other mandates.
...
When adopting a StatementOfIntent instance, no parameters are required. The mandate is designed to only create proposals without executing them.
