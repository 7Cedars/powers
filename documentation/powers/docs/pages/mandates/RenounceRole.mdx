...
RenounceRole is an electoral mandate that allows accounts to voluntarily resign from a specific role. It provides a mechanism for role holders to self-revoke their role assignment.
...
When adopting a RenounceRole instance, two parameters must be provided:
