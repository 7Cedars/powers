...
AdoptLaws is an executive law that enables the adoption of new laws into the Powers protocol. It provides a mechanism to add new governance rules and functionality to the system.
...
When adopting an AdoptLaws instance, no parameters are required. The law is designed to facilitate the adoption of other laws.
