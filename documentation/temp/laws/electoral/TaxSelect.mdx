...
TaxSelect is an electoral law that enables direct assignment or revocation of a specific role to any account. It provides a mechanism for authorized accounts to manage role assignments without requiring nominations.
