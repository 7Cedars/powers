...
//         (address electionStartAddress,,) = daoMock.getAdoptedLaw(electionStartId);
...
//         (address electionListAddress,,) = daoMock.getAdoptedLaw(electionListId);
...
//         (address electionTallyAddress,,) = daoMock.getAdoptedLaw(electionTallyId);
