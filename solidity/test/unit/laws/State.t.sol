...
//         (address addressesMappingAddress,,) = daoMock.getAdoptedLaw(addressesMapping);
...
//         uint16 grant = 1;
//         (address grantAddress,,) = daoMock.getAdoptedLaw(grant);
...
//         (address VoteOnAccountsAddress,,) = daoMock.getAdoptedLaw(voteOnAccounts);
...
//         (address nominateMeAddress,,) = daoMock.getAdoptedLaw(nominateMe);
...
//         (address stringsArrayAddress,,) = daoMock.getAdoptedLaw(stringsArray);
...
//         (address tokensArrayAddress,,) = daoMock.getAdoptedLaw(tokensArray);
