...
// //     (, , conditions) = separatedPowers.getAdoptedLaw(1);
...
// //     // Check if proposal passed
// //     (, , conditions) = separatedPowers.getAdoptedLaw(2);
// //     quorumReached = (forVote + abstainVote) * 100 / roleCount > conditions.quorum;
// //     voteSucceeded = forVote * 100 / roleCount > conditions.succeedAt;
...
// //     // Check if proposal passed
// //     (, , conditions) = separatedPowers.getAdoptedLaw(3);
// //     quorumReached = (forVote + abstainVote) * 100 / roleCount > conditions.quorum;
// //     voteSucceeded = forVote * 100 / roleCount > conditions.succeedAt;
...
// //     // Check if proposal passed
// //     (, , conditions) = separatedPowers.getAdoptedLaw(4);
...
// //     vm.expectRevert();
// //     separatedPowers.getAdoptedLaw(9);
// // }
// }
