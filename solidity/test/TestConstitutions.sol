...
contract TestConstitutions is Test {
    ...
    function powersTestConstitution(address daoMock) external returns (PowersTypes.MandateInitData[] memory mandateInitData) {
        ...
        constitution.push(PowersTypes.MandateInitData({
            ...
            targetMandate: getMandateAddress("PresetActions_Single"), // presetSingleAction
    ...
    function mandateTestConstitution( address daoMock, address simpleErc1155 ) public returns (PowersTypes.MandateInitData[] memory mandateInitData) {
        ...
        constitution.push(PowersTypes.MandateInitData({
            ...
            targetMandate: getMandateAddress("PresetActions_Single"), // presetAction
            config: abi.encode(targets, values, calldatas),
            conditions: conditions
        }));
        delete conditions;
    ...
    function executiveTestConstitution( address daoMock, address simpleErc1155, address returnDataMock ) external returns (PowersTypes.MandateInitData[] memory mandateInitData) {
        ...
        constitution.push(PowersTypes.MandateInitData({
            ...
            targetMandate: getMandateAddress("PresetActions_Single"), // PresetActions_Single (multi mandate)
            config: abi.encode(targets, values, calldatas),
            conditions: conditions
        }));
        delete conditions;
        ...
        constitution.push(PowersTypes.MandateInitData({
            ...
            targetMandate: getMandateAddress("PresetActions_Multiple"), // PresetActions_Multiple (multi mandate)
        ...
        PowersTypes.MandateInitData({
            ...
            targetMandate: getMandateAddress("PresetActions_Single"), // PresetActions_Single
            config: abi.encode(
        ...
        constitution.push(PowersTypes.MandateInitData({
            ...
            targetMandate: getMandateAddress("Mandates_Adopt"), // Mandates_Adopt (executive mandate)
            config: abi.encode(),
            conditions: conditions
        }));
        delete conditions;
