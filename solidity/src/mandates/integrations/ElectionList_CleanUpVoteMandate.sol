...
contract ElectionList_CleanUpVoteMandate is Mandate { 
    ...
    { 
        ...
        mem.returnData = IPowers(powers).getActionReturnData(
            MandateUtilities.computeActionId(
                mem.createVoteMandate_Id,
                mandateCalldata,
                nonce
            ),
            0
        ...
        targets[0] = powers;
        calldatas[0] = abi.encodeWithSelector(IPowers.revokeMandate.selector, mem.voteMandate_Id, nonce, "Cleaning up vote mandate.");
