...
//     constructor() {
//         emit Law__Deployed(
//             abi.encode("address ElectionList", "address ElectionTally", "uint16 RoleId", "uint32 MaxToElect")
//         );
//     }
...
//         (address electionListAddress, address electionTallyAddress, uint16 roleId, uint32 maxToElect) =
//             abi.decode(config, (address, address, uint16, uint32));
...
//         (mem.nominateMeAddress, mem.nominateMeHash, mem.active) = Powers(payable(powers)).getAdoptedLaw(mem.nominateMeId);
...
//         MemoryData memory mem;
//         (mem.startElection, mem.endElection, mem.nominateMeAddress, mem.nominateMeHash) =
//             abi.decode(stateChange, (uint48, uint48, address, bytes32));
...
//     function getElectionData(bytes32 lawHash)
//         public
//         view
//         returns (
//             uint48 startElection,
