...
//         (mem.startElectionLaw,,) = Powers(payable(powers)).getAdoptedLaw(mem.startElectionId);
//         (mem.nominateMeLaw,,) = Powers(payable(powers)).getAdoptedLaw(mem.nominateMeId);
...
//         (mem.VoteOnAccountsLaw,,) = Powers(payable(powers)).getAdoptedLaw(mem.VoteOnAccountsId);
