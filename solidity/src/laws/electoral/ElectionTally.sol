...
//             Powers(payable(msg.sender)).getAdoptedLaw(mem.electionListId);
...
//             Powers(payable(msg.sender)).getAdoptedLaw(mem.electionStartId);
...
//         (mem.electionListAddress, mem.electionListHash,) = Powers(payable(powers)).getAdoptedLaw(mem.electionListId);
