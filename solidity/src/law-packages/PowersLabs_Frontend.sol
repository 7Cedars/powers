...
contract PowerLabs_Frontend is Law {
    struct Mem {
        uint16 lawCount;
        address safeProxy;
        bytes signature; 
        ...
        returns (uint256 actionId, address[] memory targets, uint256[] memory values, bytes[] memory calldatas)
    {
        ...
        // 1: adopt new uri. 
        calldatas[0] = abi.encodeWithSelector(IPowers.setUri.selector, "https://aqua-famous-sailfish-288.mypinata.cloud/ipfs/bafkreibx4y4y42ktc2w7bcoebf7d3wiy7yn5gjhwwycnclk4yygbc3xs3y");
