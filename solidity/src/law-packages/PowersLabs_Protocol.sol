...
contract PowerLabs_Protocol is Law {
        ...
        returns (uint256 actionId, address[] memory targets, uint256[] memory values, bytes[] memory calldatas)
    {
        ...
        // 1: adopt new uri. 
        calldatas[0] = abi.encodeWithSelector(IPowers.setUri.selector, "https://aqua-famous-sailfish-288.mypinata.cloud/ipfs/bafkreigye2u5mzkfhxtcmxl4plrkhv2hzkvvctvcw64pc5ogkxtix35ggi");
